...
internal sealed class RuntimeOptions {
    ...
    public static RuntimeOptions Parse(string[] args) {
        const string usage = "Usage: Malcolm.Runtime.exe <game-dir> <fresh-log-file> (--baseline | --encounter <json-file> | --residential <art-directory>) or --self-test";
        ...
        else if (args.Length == 4 && args[2] == "--residential" && !String.IsNullOrWhiteSpace(args[3])) result.ResidentialDirectory = args[3];
