...
internal static class BossProbe
{
    ...
    public static int Main(string[] args)
    {
        try
        {
            ...
            if (args.Length != 3) throw new ArgumentException("Usage: BossProbe.exe GAME_ROOT SCENE_ZPBN READER_TYPE (or --self-test)");
            if (args[2] != "Baxter" && args[2] != "BaxterLaser" && args[2] != "FootShortMelee" && args[2] != "PlayerSpawnPoint") throw new ArgumentException("Unsupported actor reader");
            ...
            int found = 0;
            foreach (int offset in FindRecords(data, "ParisSerializer."+args[2]+"ReadWriter"))
            {
