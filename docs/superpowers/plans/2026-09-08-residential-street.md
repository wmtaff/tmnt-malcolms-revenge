# Residential street implementation plan

**Spec:** docs/residential-design.md
**Goal:** Prototype a summer suburban route from a light-pink house to a community park, with Foot Soldiers followed by native Baxter, and a repeatable OpenAI tile-generation/review workflow.
